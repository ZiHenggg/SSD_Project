...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            if (groupId) {
                const deleteModal = document.querySelector(`.delete-modal[data-group-id="${groupId}"]`); // Find the corresponding modal
                if (deleteModal) {
    ...
    cancelButtons.forEach(function(cancelButton) {
        cancelButton.addEventListener('click', function() {
            const groupId = cancelButton.closest('.delete-modal').getAttribute('data-group-id');
            const deleteModal = document.querySelector(`.delete-modal[data-group-id="${groupId}"]`);
            if (deleteModal) {
    ...
    confirmButtons.forEach(function(confirmButton) {
        confirmButton.addEventListener('submit', function(event) {
            ...
            const groupId = confirmButton.closest('.delete-modal').getAttribute('data-group-id'); // Get the group ID
