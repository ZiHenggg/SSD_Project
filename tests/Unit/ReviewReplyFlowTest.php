...
class ReviewReplyFlowTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->replyController = new ReplyPageController($replyControl, $reviewControl, $this->createMock(PDO::class));
    }
    ...
    public function testSubmitReplyNotInSameGroup(): void
    {
        ...
        $reviewControl = new \App\Control\ReviewControl($mockReviewRepo, $this->createMock(StudentStatsRepository::class));
        $this->replyController = new \App\Boundary\ReplyPageController($replyControl, $reviewControl, $this->createMock(PDO::class));
